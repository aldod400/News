...
@section('title', __('general.edit_advisory_board_member'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('general.edit_advisory_board_member') }}</h3>
                ...
                <form action="{{ route('admin.advisory-board.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="name_en" 
                                           name="name_en" 
                                           value="{{ old('name_en', json_decode($member->getRawOriginal('name'), true)['en'] ?? '') }}" 
                                           required>
                                    @error('name_en')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="name_ar" 
                                           name="name_ar" 
                                           value="{{ old('name_ar', json_decode($member->getRawOriginal('name'), true)['ar'] ?? '') }}" 
                                           required
                                           dir="rtl">
                                    @error('name_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="job_title_en" 
                                           name="job_title_en" 
                                           value="{{ old('job_title_en', json_decode($member->getRawOriginal('job_title'), true)['en'] ?? '') }}" 
                                           required>
                                    @error('job_title_en')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="job_title_ar" 
                                           name="job_title_ar" 
                                           value="{{ old('job_title_ar', json_decode($member->getRawOriginal('job_title'), true)['ar'] ?? '') }}" 
                                           required
                                           dir="rtl">
                                    @error('job_title_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            @if($member->image)
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ __('general.current_image') }}</label>
                                        <div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="image" class="form-label">
                                        {{ $member->image ? __('general.change_image') : __('general.profile_image') }}
                                    </label>
                                    <input type="file" 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="image-preview" class="mb-3" style="display: none;">
                                    <label class="form-label">{{ __('general.new_image_preview') }}</label>
                                    <div>
