...
class SetupAboutUs extends Command
{
    protected $signature = 'setup:about-us';
    protected $description = 'Setup About Us tables and sample data';

    public function handle()
    {
        $this->info('Setting up About Us system...');
        ...
        try {
            ...
            if (!Schema::hasTable('about_us')) {
                ...
                ");
                $this->info('✓ about_us table created');
            } else {
                $this->info('✓ about_us table already exists');
            }

            // Create editorial_board table
            if (!Schema::hasTable('editorial_board')) {
                DB::statement("
                ...
                ");
                $this->info('✓ editorial_board table created');
            } else {
                $this->info('✓ editorial_board table already exists');
            }
            ...
            if (!Schema::hasTable('offices')) {
                ...
                ");
                $this->info('✓ offices table created');
            } else {
                $this->info('✓ offices table already exists');
            }
            ...
            if ($aboutUsCount == 0) {
                ...
                $this->info('✓ About Us content inserted');
                ...
                $this->info('✓ Editorial board members inserted');
                ...
                $this->info('✓ Offices inserted');
            } else {
                $this->info('✓ Data already exists, skipping insert');
            }

            $this->info('');
            $this->info('🎉 About Us system setup completed successfully!');
            $this->info('You can now access the About Us page at: /about-us');
            $this->info('Admin panel: /admin/about-us');
